...
#ifdef __ZPU_ELF_GCC__
    #define compiler  "zpu-elf-gcc version 3.4.2"
    #define options   "-c -g -Wall -Os"
//    #define sin sinf
//    #define cos cosf
//    #define tan tanf
//    #define log logf
...
#ifdef __CATALINA__ 
    #define compiler  "Catalina 2.6"
    #define options   "-lcx -lm -x2 -O3 -D RAMBLADE -M256k -D CLOCK"
#endif
